...
def _build_info_text(player: Character) -> str:
    return (
        ...
        "• 🏕 Вылазка — война, переходы, ⚔️ арена (тренировка на базе), рейды и 👥 кооп-вылазка "
        "(можно эвакуировать раненого напарника).\n"
        ...
        "• 🏚 Рейды на склад/гараж врага (в «🪖 Рейды»): только против фракций не в союзе; "
        "успех — крадёте склад/канистры/технику, провал — деньги, HP и рейтинг.\n"
        ...
        "• 🏟 Арена: на домашней базе — бесконечные волны НПС; учебный бой без штрафа по HP; "
        "награда как за лёгкое задание, если зачистил ≥1 волну.\n"
