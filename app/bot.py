...
def _build_info_text(player: Character) -> str:
    return (
        ...
        "  В коопе: эвакуация раненого (рядом + тащить на старт). В рейде: «💊 Поднять» союзника "
        ...
        "(нужен детектор).\n"
        "• ⚔️ Война: нейтральные — соло (6×6) или лобби от 5; занятые точки — только лобби "
        "(тактический штурм 9×9).\n"
