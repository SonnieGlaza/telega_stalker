...
TUTORIAL_PAGES: tuple[tuple[str, str], ...] = (
    ...
    (
        "Арена",
        "«🏕 Вылазка» → «⚔️ Арена» — тренировка на домашней базе группировки. "
        "Бесконечные волны НПС на тактической сетке: с каждой волной сильнее снаряжение, "
        "на поле 3 аптечки арены. Поражение не бьёт по HP в БД — это учебный бой. "
        "Если зачистил хотя бы одну волну и покинул арену — награда как за лёгкое задание "
        "(472–717 RU и рейтинг +4).",
    ),
    (
        "Экономика и гараж",
